...
from views import get_all_animals, get_single_animal, get_single_customer, get_all_customers, get_all_locations, get_single_location, create_animal, get_single_employee, get_all_employees, create_location, create_employee, create_customer, delete_animal, delete_location, delete_employee, delete_customer, update_animal, update_employee, update_customer, update_location
import json
